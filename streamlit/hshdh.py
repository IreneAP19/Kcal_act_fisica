...
top_image = Image.open("../img/lemur.png")

# Crear columnas para organizar el título y la imagen
col1, col2 = st.columns([3, 1])  # La primera columna es más ancha que la segunda

with col1:
    st.markdown("# Bienvenido a la Calculadora de IMC y Calorías Diarias")
